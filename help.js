...
const getGeneralHelpMessage = (language) => {
	if (language === "french") {
		return "Je suis un :robot: qui affiche des images de <:3x3solved:693841238461382739>\n"
			...
			+ "\nSi j'ai un bug, merci d'envoyer un MP à Cubeur-manchot#7706 pour qu'il puisse me réparer :wrench:";
	} else { // english
		return "I'm a :robot: that displays <:3x3solved:693841238461382739> images\n"
			...
			+ "\nIf I have a bug, please send a PM to Cubeur-manchot#7706 so he can repair me :wrench:";
	}
};
